    ...
    <div className="">
      <div className="drawer lg:drawer-open ">
        ...
        <div className="drawer-content">
          ...
          <label
            htmlFor="my-drawer-2"
            className="btn btn-primary drawer-button lg:hidden menu-icon z-10"
          >
            ☰
          </label>
        </div>
        <div className="drawer-side">
          ...
          <ul className="menu p-4 w-80 min-h-full lg:fixed bg-cyan-50 text-base-content text-lg">
            ...
            <img
              className="w-[120px]"
              src="https://app.predis.ai/predis_logo.png"
              alt=""
            />
            ...
            <li>
              <NavLink to="/dashboard/sub-category">
                <FaCalendarAlt></FaCalendarAlt>Sub Category
              </NavLink>
            </li>
            <li>
