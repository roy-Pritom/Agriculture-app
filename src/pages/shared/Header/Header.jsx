...
const NavLinks=<>
              ...
              <li> <Link>Major Crops</Link> </li>
              <li> <Link>Documents & Reports</Link> </li>
              {
              user &&
              <li>
                <Link to='/dashboard'>
    ...
    return (
        ...
        <div className="navbar-start">
          ...
          <a id="gradientText" className="btn btn-ghost lg:text-2xl text-xl font-bold text-">Agriculture</a>
        </div>
